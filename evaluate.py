...
def main():
    ...
    #models = {'QCD < 400 Many iterations'    : 'models/svjbdt_Jan31_lowmass_iterative_qcdonly.json'}
    models = {'100+38 est/iter QCD+tt < 400'    : 'models/svjbdt_Feb28_lowmass_iterative_qcdtt_100p38.json'}
