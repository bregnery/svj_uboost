...
def main():
    ...
    models = {#'iterative Semi-visible Forest'    : directory+'ensebled_'+date+'_semi-visible_forest.json',
              ...
              #'many QCD only (iter) < 400'    : 'models/svjbdt_Jan26_lowmass_iterative_qcdonly.json',
              #'many QCD only (iter) < 400, rinv=0.3'    : 'models/svjbdt_Jan31_lowmass_iterative_qcdonly.json',
              #'one iter QCD only < 400'    : 'models/svjbdt_Feb06_lowmass_iterative_qcdonly.json',
              #'no new est QCD only < 400'    : 'models/svjbdt_Feb07_lowmass_iterative_qcdonly.json',
              #'10 est/iter QCD only < 400'    : 'models/svjbdt_Feb08_10newtrees_qcd_only.json',
              #'1 est/iter QCD only < 400'    : 'models/svjbdt_Feb28_lowmass_iterative_qcdonly_1per1000iter.json',
              #'50 est/iter QCD only < 400'    : 'models/svjbdt_Feb14_qcdonly_50treespermasspoint.json',
              #'100 + 38 est/iter QCD only < 400'    : 'models/svjbdt_Feb14_qcdonly_100_38perIter.json',
              #'100 + 38 est/iter QCD + tt < 400'    : 'models/svjbdt_Feb28_lowmass_iterative_qcdtt_100p38.json',
              #'1 est 1000 iter QCD + tt < 400'    : 'models/svjbdt_Feb28_lowmass_iterative_qcdtt_1est1000iter.json',
              '100 + 20 est/iter all sig & QCD + tt'    : 'models/svjbdt_Apr11_lowmass_iterative_qcdonly.json',
